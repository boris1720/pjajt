...
var novosti = require('./routes/novosti');
var psihodelici = require('./routes/psihodelici');
var iskustva = require('./routes/iskustva');
...
app.use('/users', users);
app.use('/auth', auth);
app.use('/novosti', novosti);
app.use('/psihodelici', psihodelici);
app.use('/iskustva', iskustva);
app.use('/onama', onama);
